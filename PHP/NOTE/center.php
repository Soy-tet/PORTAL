<div class="container_center">
            <div class="scroll">
                <div class="pano_content">
                    ...
                    <a href="\PORTAL\PORTAL\Dashboard\SQL\INSERT\Clone\team.php"><button class="button-38" role="button">Let's add your note</button></a>
                </div>
               ...
               while($row10 = mysqli_fetch_assoc($result_note)){
                ?>  
                    ...
                    <?php
                     ...
                     <div class="container_card_team">
                        <a href="../note_add/note_add.php"> <img src="../../IMG/folder.png" alt="folder"></a>
